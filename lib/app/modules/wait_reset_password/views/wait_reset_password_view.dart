...
class WaitResetPasswordView extends GetView<WaitResetPasswordController> {
  const WaitResetPasswordView({super.key});
  @override
            ...
            children: [
              ...
              Obx(
                () => controller.isLoading.value
                    ...
                    : TextButton(
                        onPressed: () =>
                            controller.resetPassword(controller.email.value),
                        child: Text(
                          'Kirim Ulang',
                          style: AppTextStyle.textButton,
                        ),
